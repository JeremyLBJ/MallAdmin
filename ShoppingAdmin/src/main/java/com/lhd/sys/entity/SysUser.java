...
public class SysUser {
	...
	public String toString() {
		return "SysUser [id=" + id + ", name=" + name + ", loginname=" + loginname + ", address=" + address + ", sex="
				+ sex + ", remark=" + remark + ", pwd=" + pwd + ", hiredate=" + hiredate + ", mgr=" + mgr
				+ ", available=" + available + ", ordernum=" + ordernum + ", type=" + type + ", imgpath=" + imgpath
				+ ", salt=" + salt + ", deptid=" + deptid + ", leadername=" + leadername + ", deptname=" + deptname
				+ "]";
	}
